...
if [[ "${BACKEND}" == aks ]]; then
    ...
    export EKS_DEPLOYER_ROLE_ARN EKS_CLUSTER_ROLE_NAME EKS_CLUSTER_ROLE_ARN EKS_WORKER_NODE_ROLE_NAME EKS_WORKER_NODE_ROLE_ARN EKS_CLUSTER_NAME KUBE_AUTHORIZED_ROLE_ARN AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY
