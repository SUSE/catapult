...
export GINKGO_EXTRA_FLAGS="${GINKGO_EXTRA_FLAGS:-}"
...
export SCF_REPO="${SCF_REPO:-https://github.com/cloudfoundry-incubator/kubecf}"
export SCF_BRANCH="${SCF_BRANCH:-master}"
